...
@register_microservice(name="opea_service@prepare_mm_doc_redis", endpoint="/v1/mm_dataprep", host="0.0.0.0", port=6007)
...
@register_microservice(
    name="opea_service@prepare_mm_doc_redis_file", endpoint="/v1/mm_dataprep/get_file", host="0.0.0.0", port=6008
)
@traceable(run_type="tool")
...
@register_microservice(
    name="opea_service@prepare_mm_doc_redis_del", endpoint="/v1/dataprep/delete_file", host="0.0.0.0", port=6009
)
@traceable(run_type="tool")
...
if __name__ == "__main__":
    create_upload_folder(upload_folder)
    opea_microservices["opea_service@prepare_mm_doc_redis"].start()
    opea_microservices["opea_service@prepare_mm_doc_redis_file"].start()
    opea_microservices["opea_service@prepare_mm_doc_redis_del"].start()